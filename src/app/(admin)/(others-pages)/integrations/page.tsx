...
export const metadata: Metadata = {
  title: "Integrations | TailAdmin - Next.js Admin Dashboard Template",
  description:
    "Connect your workspace with third-party tools like Mailchimp, Slack, and Trello through TailAdmin Integrations.",
};
