    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/3">
      <div className="mb-5 flex flex-col justify-between gap-5 sm:flex-row">
        ...
        <div className="flex  items-center gap-3 lg:flex-row">
          ...
          <button className="shadow-theme-xs inline-flex h-11 items-center gap-2 rounded-lg bg-white px-4 py-3 text-sm font-medium text-gray-700 ring-1 ring-gray-300 transition ring-inset hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-400 dark:ring-gray-700 dark:hover:bg-white/3">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
