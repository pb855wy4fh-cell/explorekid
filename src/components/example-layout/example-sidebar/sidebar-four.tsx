...
export default function SidebarFour() {
  ...
  return (
    <aside
      className={`sidebar fixed top-16 xl:sticky xl:top-0 left-0 z-9999 flex h-screen w-[290px] flex-col border-r border-gray-200 bg-gray-50 transition-all duration-300 dark:border-gray-800 dark:bg-gray-900 ${
        isMobileOpen ? "translate-x-0" : "-translate-x-full"
      } xl:translate-x-0 ${!isExpanded ? "xl:w-0 xl:overflow-hidden xl:border-r-0 xl:min-w-0" : ""}`}
    >
      {/* SIDEBAR HEADER */}
      <div className="px-5 pt-8 xl:pt-5 pb-7">
        <div
